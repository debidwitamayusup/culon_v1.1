<body class="app  sidebar-mini">
    ...
    <div class="page">
        <div class="page-main">
            <div class=" app-content mt-7">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card-header bg-red">
                                        <h3 class="card-title">Detail Interval Call Daily</h3>
                                    </div>
                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group m-0">
                                                            <div class="custom-controls-stacked">
                                                                <label class="custom-control custom-checkbox">
                                                                    <input type="checkbox"
                                                                        class="custom-control-input all-checklist"
                                                                        id="check-all-channel" name="check-all"
                                                                        value="All">
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-6">
                        <div class="card">
                            <div class="card-header bg-red">
                                <h4 class="card-title">Detail Inteval Call Monthly</h4>
                            </div>
                            <div class="card-body">
                                ...
                                <canvas id="echartVertical" class="h-400"></canvas>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-6">
                        <div class="card">
                            <div class="card-header bg-red">
                                <h4 class="card-title">Detail Inteval Call Yearly</h4>
                            </div>
                            <div class="card-body">
                                <div class="d-flex bd-highlight">
                                    <div class="p-2 flex-grow-1 bd-highlight">
                                ...
                                <div class="card-body">
                                    <div id="echartYear" class="chartsh-agentYear overflow-hidden"></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <script src="<?= base_url()?>assets/public/js/app/app-agent-interval.js"></script>