<div class=" app-content">
		...
		<div class="page-header d-flex bd-highlight">
			<div class="flex-grow-1 bd-highlight">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active mt-2" aria-current="page">Detil Pengajuan Cuti</li>
				</ol>
			</div>
		</div>
					...
					<div style="padding:10px 15px;">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>: Ya <input name="approveLeader" class="approveLeader" type="radio" id="yaLeader" value="Y" disabled></td>
                                <td>Tidak <input name="approveLeader" class="approveLeader" type="radio" id="tidakLeader" value="N" disabled></td>
                            </tr>
                            <!-- <tr>
                            ...
                            <tr>
                                ...
                                <td>: Ya <input name="approveHRD" class="approveHRD" type="radio" id="yaHrd" value="Y"></td>
                                <td>Tidak <input name="approveHRD" class="approveHRD" type="radio" id="tidakHrd" value="N"></td>
                            </tr>
                        </table>
					</div>
				</div>
					...
					<div style="padding: 10px 15px;">
						...
						<div class="row mb-4" style="margin-right:0px; margin-left:-2px;">
							<div class="col-xs-auto ml-1">
									<button class="btn btn-sm btn-primary" type="button" style="height:35px" id="btn-simpan"><i
											class="fas fa-download mr-2"></i>Simpan</button>
							</div>		
						</div>
					</div>
				</div>
	...
	<script src="<?= base_url()?>assets/public/js/app/detil-approval-pengajuan-cuti-hrd.js"></script>