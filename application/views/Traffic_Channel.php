                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col">
                                        <h6 class="text-muted mb-0 mt-1">Total Ticket</h6>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="dash-2">
                                            ...
                                            <span class="text-muted"><span class="font-weight-bold "><i class="fas fa-arrow-circle-down text-danger"></i> 10%</span>  Total Ticket </span>
                                        </div>
                                    </div>
                                    <div class="col col-auto">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="dash-2">
                                            <h2 class="mb-2"><span class="counter font-weight-extrabold num-font">500</span></h2>
                                            <span class="text-muted"><span class="font-weight-bold"><i class="fas fa-arrow-circle-down text-danger"></i> 15%</span>  Case In Decreased</span>
                                        </div>
                                    </div>
                                    <div class="col col-auto">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="dash-2">
                                            ...
                                            <span class="text-muted"><span class="font-weight-bold"><i class="fas fa-arrow-circle-down text-danger"></i> 5%</span>  Case Out Decresed</span>
                                        </div>
                                    </div>
                                    <div class="col col-auto">
