                        ...
                        <div class="text-center mb-2 mt-6">
                            ...
                            <div class="card-body">
                                <div class="text-center mb-2">
                                    <img id="previewing" src="<?=base_url()?>public/user/unknown-avatar.jpg"
                                        style="border-radius:50%; width:50%;">
                                    <h6><a id="uploadImageLink" class="font12 mt-2" style="color:#3c8ae2" href="#">Edit Photo Profile</a></h6>
                                    <input id="uploadImage" type="file" accept="image/*" name="image_user" style="display:none";/>
                                ...
                                <div class="col-sm-auto mb-3">
                                    <div class="input-group border-input-group error" id="phoneDiv">
                                        <div class="input-group-prepend">
                                            ...
                                            placeholder="08xx xxxx xxxx" name="phone">
                                    </div>
                                ...
                                <div class="text-center mb-5 mt-5">
                                    <button class="btn  btn-sm btn-sign text-white mr-5"
                                        style="border-radius:8px !important;" id="btn-cancel">Cancel</button>
                                    <button type="button" class="btn btn-sm btn-sign text-white ml-5"
		...
		<div class="modal-content" style="border-radius:8px; border:0px; width:68% !important">
			...
			<div class="modal-body">
				...
				<div class="text-center mb-2 mt-2">
					<button class="btn btn-sm btn-light mr-5" style="border-radius:8px !important;"
