                            ...
                            <div class="d-flex align-items-end flex-column bd-highlight">
                                <div class="card-options d-none d-sm-block">
                                    <div class="btn-group btn-sm">
                                        <a href="<?=base_url()?>main/monitoring_ticket_time" class="btn btn-red btn-sm" id="btn-day">
                                            <span class="">Day</a></span>
                                        <a href="<?=base_url()?>main/monitoring_ticket_time_w" class="btn btn-light btn-sm" id="btn-week">
