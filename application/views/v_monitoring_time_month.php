    ...
    <div class="page">
        <div class="page-main">
            <div class=" app-content mt-7">
                                ...
                                <div class="card-options d-none d-sm-block">
                                    <div class="btn-group btn-sm">
                                        ...
                                        <a href="<?=base_url()?>main/monitoring_ticket_time_m"
                                            class="btn btn-red btn-sm" id="btn-month">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12">
                            <div class="card overflow-hidden">
                                ...
                                <div class="card-body">
                                    <div class="row mb-3">
                                        <div class="col-md-3">
                                            <div class="w-75 input-group">
                                                ...
                                                <select name="select-month" id="select-month" class="w-75 form-control">
                                    ...
                                    <div id="echartMonitoringTimeMonth" class="chartsh overflow-hidden"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-md-12">
                            <div class="card overflow-hidden">
                                ...
                                <div class="card-body">
                                    <canvas id="pieTicketTimeMonth" class="donutShadow overflow-hidden"></canvas>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-7 col-md-12">
                            <div class="card overflow-hidden">
                                ...
                                <div class="card-body">
                                    <div id="echartTicketTimeMonth" class="chartsh overflow-hidden"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <script src="<?= base_url()?>assets/public/js/app/app-monitoring-time-month.js"></script>