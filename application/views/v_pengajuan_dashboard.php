<div class=" app-content">
    <div class="side-app">
        <div class="page-header d-flex p-2 bd-highlight">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active mt-2" aria-current="page">Dashboard Pengajuan Cuti</li>
            </ol>
        </div>
        <!--Page Header-->
            ...
            <div class="col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-header-small">
                        <h5 class="card-title-small card-pt10">Daftar Pengajuan Cuti Anda</h5>
                    </div>
                    <div class="card-body">
                        <div class="row mb-2">
    ...
    <!--Plugin -->
    <script src="<?=base_url()?>assets/public/js/app/app-pengajuan-dashborad.js"></script>