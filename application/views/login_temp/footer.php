		...
		<script src="<?php echo base_url();?>assets/js/vendors/jquery.rating-stars.js"></script>
		...
		<script src="<?php echo base_url();?>assets/js/vendors/jquery.mCustomScrollbar.concat.min.js"></script>
