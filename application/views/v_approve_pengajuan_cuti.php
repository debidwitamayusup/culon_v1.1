<div class=" app-content">
    <div class="side-app">
        <div class="page-header d-flex p-2 bd-highlight">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active mt-2" aria-current="page">Approve Pengajuan Cuti</li>
            </ol>
        </div>
        <!--Page Header-->
    ...
    <!--Plugin -->
    <script src="<?=base_url()?>assets/public/js/app/app-approval-pengajuan-dashboard.js"></script>