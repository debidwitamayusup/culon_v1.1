(function($) {
    ...
    var chartdata = [{
        name: 'Ticket',
        type: 'bar',
        data: [10, 15, 9, 18, 10, 15,90]
    }];
    var chart = document.getElementById('echartMonitoringTimeWeek');
	...
	var chartTicketTime = document.getElementById('echartTicketTimeWeek');
    ...
    var ctx = document.getElementById( "pieTicketTimeWeek" );
    ctx.height = 299;
