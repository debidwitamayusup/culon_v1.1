...
function drawTableCOFByChannel(response){
    ...
    if(response.data.length != 0){   
        ...
        $('#tabelCOFByChannel').find('tfoot').append('<tr>'+
            ...
            '<td class="text-right">'+sumART.toString().substring(1)+'</td>'+
            '<td class="text-right">'+sumAHT.toString().substring(1)+'</td>'+
            '<td class="text-right">'+sumAST.toString().substring(1)+'</td>'+
