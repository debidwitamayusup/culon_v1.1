...
$(document).ready(function() {
    ...
    getDropdownJenisCuti(items.nomorInduk)
...
function simpanApprove(idPengajuan, stApprove){
    $.ajax({
        type: 'POST',
        url: base_url + 'api/CutiController/simpanApproveLeader',
        data: {
            "idPengajuan": idPengajuan,
            "stApprove": stApprove,
            "idApproveLeader": items.nomorInduk
        },
        ...
        success: function(r) {
            ...
            if(response.status == true){
                alert("Status Approval: "+stApprove);
                window.location = base_url + '/main/v_approve_pengajuan'
            }else{
                alert("Submit Approval Gagal");
            }
        },
        error: function(r) {
            //console.log(r);
...
(function($) {
    ...
    $('#btn-simpan').click(function(){
        var stApprove = $(".approveLeader:checked").val();
        simpanApprove(idUnikCuti, stApprove);
    });

    // const radioRequest = document.querySelectorAll('.input-radio[name=approveLeader]');
    // $(".approveLeader").change(function(){
    //     var val = $(".approveLeader:checked").val();
    //     alert(val);
    // });
