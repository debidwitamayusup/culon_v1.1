...
function simpanApprove(idPengajuan, stApprove){
    $.ajax({
        type: 'POST',
        url: base_url + 'api/CutiController/simpanApproveHRD',
        data: {
            "idPengajuan": idPengajuan,
            "stApprove": stApprove,
            "idApproveHRD": items.nomorInduk
        },
        ...
        success: function(r) {
            ...
            if(response.status == true){
                ...
                window.location = base_url + '/main/v_approve_pengajuan_hrd'
            }else{
...
(function($) {
    ...
    $('#btn-simpan').click(function(){
        var stApprove = $(".approveHRD:checked").val();
