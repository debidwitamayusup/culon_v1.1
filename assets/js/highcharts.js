  ...
  'use strict';
	...
	Highcharts.chart('highchart3', {
		...
		series: [{
			...
			colors: ['#1396cc', '#089e60', '#cc66ff', '#ff9933', '#94f24c', '#8c31e4', '#aa4cf2', '#cc66ff']
		}]
	});
	...
	Highcharts.chart('highchart6', {
		...
		colors: ['#8c31e4', '#ff9933' ,'#cc66ff', '#1396cc', '#089e60' ],
		responsive: {
			rules: [{
				condition: {
					maxWidth: 500
	...
	colors: ['#1396cc', '#089e60', '#ff9933', '#00bcd4', '#5e5baa', '#FF9655', '#f1c40f', '#6AF9C4'],
    series: [{
        type: 'column',
        colorByPoint: true,
